...
public interface HomeDataService {
     ...
     Observable<OrderBean> getOrderData(@FieldMap Map<String, Object> options);

     @FormUrlEncoded
     @POST("mobile/index.php?act=member_payment&op=payment_list")
     Observable<PayMentInfo> getPayInfoData(@FieldMap Map<String, Object> options);

     @FormUrlEncoded
     @POST("mobile/index.php?act=member_payment&op=pay_new")
     Observable<PredepositBean> getPredeposit(@FieldMap Map<String, Object> options);
}
