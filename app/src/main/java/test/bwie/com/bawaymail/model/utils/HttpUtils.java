...
public class HttpUtils {
    ...
    public static void  getPredeposit(Map<String, Object> map,final CallBackDataF<PredepositBean> callBackDataF){
        Retrofit retrofit1 = create(Constant.LINK_MAIN);
        HomeDataService service = retrofit1.create(HomeDataService.class);
        service.getPredeposit(map)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<PredepositBean>() {
                    @Override
                    ...
                    @Override
                    public void onNext(PredepositBean value) {
    ...
    public static void  getPayInfoData(Map<String, Object> map,final CallBackDataF<PayMentInfo> callBackDataF){
        Retrofit retrofit1 = create(Constant.LINK_MAIN);
        HomeDataService service = retrofit1.create(HomeDataService.class);
        service.getPayInfoData(map)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<PayMentInfo>() {
                    @Override
                    public void onSubscribe(Disposable d) {
                    ...
                    @Override
                    public void onNext(PayMentInfo value) {
                        callBackDataF.callBackF(value);
                    }
    ...
    public static void  getOrderData(Map<String, Object> map,final CallBackDataF<OrderBean> callBackDataF){
        Retrofit retrofit1 = create(Constant.LINK_MAIN);
        HomeDataService service = retrofit1.create(HomeDataService.class);
        service.getOrderData(map)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    public static void  getBuyGoodsData(String key,String cart_id,String ifcart, final CallBackDataF<BuyNowBean> callBackDataF){
        Retrofit retrofit1 = create(Constant.LINK_MAIN);
        HomeDataService service = retrofit1.create(HomeDataService.class);
        Map<String, String> map = new HashMap<>();
        map.put("key",key);
